...
// We can reuse the same card component logic from the HomePage
const AppCard = ({ app }) => (
    ...
    return (
        <div className="profile-page-container">
            <header className="profile-header">
                <img 
                    src={user.avatar_url || `https://ui-avatars.com/api/?name=${user.first_name}+${user.last_name}&background=0D1117&color=fff&size=128`} 
                    alt={user.username} 
